...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pedidos_productos', function (Blueprint $table) {
            ...
            $table->decimal('precio_unitario', 10, 2); // Precio del producto en el momento del pedido
            $table->decimal('subtotal', 10, 2); // Subtotal del producto (cantidad * precio_unitario)
            $table->timestamps();
        });
    }
