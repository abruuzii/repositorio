...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/usuario/direcciones', [ProductoController::class, 'direccionUsuario']);
    Route::post('/usuario/direcciones', [ProductoController::class, 'guardarDireccionUsuario']);
});
